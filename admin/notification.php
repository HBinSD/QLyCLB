...
<aside class="club-sidebar">
    ...
    <nav class="club-menu">
        ...
        <a href="notification.php" class="club-menu-item active">
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    */
    ...
    header("Location: notification.php?success=created");
    exit;
}
    ...
    */
    ...
    if ($action === "update") {
        ...
        header("Location: notification.php?success=updated");
    ...
    */
    ...
    if ($action === "delete") {
        ...
        header("Location: notification.php?success=deleted");
                    ...
                    <div class="notification-card">
                        ...
                        <div class="notification-content">
                            ...
                            <div class="actions">
                                ...
                                <a
                                    href="notification.php?edit=<?= $tb["notification_id"] ?>"
                                    class="btn-edit"
                                >
        ...
        <?php if ($tongSoTrang > 1): ?>
            ...
            <div class="pagination">
                ...
                <?php if ($trangHienTai > 1): ?>
                    ...
                    <a
                        href="notification.php?page=<?= $trangHienTai - 1 ?>"
                    >
