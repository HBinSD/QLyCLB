...
<div class="dashboard-content">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 20px;">
        <div style="background: white; padding: 20px; border-radius: 10px; border: 1px solid #e2e8f0;">
            ...
            <p style="color: #64748b; font-size: 14px;">Khám phá các hoạt động ngoại khóa CLB và đăng ký tham gia ngay.</p>
        ...
        <div style="background: white; padding: 20px; border-radius: 10px; border: 1px solid #e2e8f0;">
            ...
            <p style="color: #64748b; font-size: 14px;">Kiểm tra và cập nhật thông tin ảnh đại diện, số điện thoại, ngày sinh.</p>
