...
<div style="display: flex; flex-direction: column; gap: 20px;"> 
    ...
    <div style="background: white; padding: 20px 25px; border-radius: 12px; border: 1px solid #e2e8f0; display: flex; justify-content: space-between; align-items: center;"> 
        <div> 
            ...
            <p style="color: #64748b; margin: 4px 0 0 0; font-size: 13px;">Quản lý và theo dõi sự kiện của CLB</p> 
        </div> 
        ...
        <table style="width: 100%; border-collapse: collapse;"> 
            <thead> 
                <tr style="background: #f8fafc; color: #475569; text-align: left; border-bottom: 2px solid #e2e8f0;"> 
                    ...
                    <th style="padding: 12px;">Mã SK</th> 
            ...
            <tbody> 
                ...
                <tr style="border-bottom: 1px solid #f1f5f9;"> 
                    ...
                    <td style="padding: 12px; font-weight: bold;"> 
                        <!-- BẤM VÀO TÊN SỰ KIỆN ĐỂ XEM DANH SÁCH SINH VIÊN -->
                        <a href="index.php?page=event-participants&id=<?= urlencode($sk->getEventId()); ?>" style="color: #1e3a5f; text-decoration: none;" title="Xem danh sách đăng ký">
                            <?= htmlspecialchars($sk->getEventName()); ?>
                        </a>
                    </td> 
                    ...
                    <td style="padding: 12px; text-align: center;"> 
                        <a href="index.php?page=event-participants&id=<?= urlencode($sk->getEventId()); ?>" style="color: #0284c7; font-weight: bold; text-decoration: none; margin-right: 8px;">Xem SV</a> | 
                        <a href="index.php?page=event-edit&id=<?= urlencode($sk->getEventId()); ?>" style="color: #2563eb; font-weight: bold; text-decoration: none; margin-right: 8px;">Sửa</a> |  
                        <a href="index.php?page=event-delete&id=<?= urlencode($sk->getEventId()); ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa?')" style="color: #ef4444; font-weight: bold; text-decoration: none;">Xóa</a> 
                    </td> 
                </tr> 
                <?php  
                    endforeach;  
