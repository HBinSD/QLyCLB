...
<div class="club-layout">
    ...
    <aside class="club-sidebar">
        ...
        <nav class="club-menu">
            ...
            <a href="index.php?page=club-member" class="club-menu-item">
    ...
    <main class="club-content">
        <?php if (empty($club)): ?>
            <div style="padding: 20px; color: #856404; background: #fff3cd; border-radius: 8px;">
            ...
            <div class="club-intro">
                ...
                <div class="club-grid">
                    ...
                    <div class="club-card full">
                        ...
                        <div class="club-value normal"><?= nl2br(htmlspecialchars($club['description'] ?? 'Chưa có mô tả')) ?></div>
                    </div>
                    <div class="club-card full">
                        <div class="club-label">Nội quy CLB</div>
                        <div class="club-value normal"><?= nl2br(htmlspecialchars($club['rule'] ?? 'Chưa có quy định')) ?></div>
                    </div>
                </div>
            </div>
        <?php endif; ?>
